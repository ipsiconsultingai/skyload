...
const FAQ_DATA: FaqItem[] = [
  {
    ...
    answer:
      "결제 완료 후 48시간 이내에 이메일로 전달됩니다. 수십만 건의 데이터를 학습한 AI가 생기부 전 영역을 정밀 분석한 후, 전임 입시 전문가가 결과를 직접 검토하고 보완하는 과정을 거칩니다. 단순히 정보를 나열하는 분석이 아니라, 실제 지원 전략까지 이어질 수 있는 수준의 완성도 높은 리포트를 받아보시게 됩니다.",
  },
  {
